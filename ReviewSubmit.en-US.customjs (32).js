...
function showMandatoryDocError(missingDocs) {
  ...
  const customerName = STATE.dclMasterData?.cr650_customername || 'this customer';
    ...
    ">
      <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1rem;">
        ...
        <h4 style="margin:0;font-size:1.15rem;font-weight:700;color:#991b1b;">
          Cannot Submit — ${missingDocs.length} Document${missingDocs.length > 1 ? 's' : ''} Missing for ${escapeHtml(customerName)}
        </h4>
      </div>
      <p style="margin:0 0 0.75rem;color:#7f1d1d;font-size:0.95rem;line-height:1.6;">
        The following mandatory document${missingDocs.length > 1 ? 's are' : ' is'} required by <strong>${escapeHtml(customerName)}</strong> before this DCL can be submitted for export.
